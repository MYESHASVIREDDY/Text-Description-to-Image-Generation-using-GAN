...
if __name__ == "__main__" :
	...
	root.title("Text Description To Image Generation using GAN for Birds")
	
	# Create Welcome to SpongeBob Mocking Text Generator label
	headlabel = Label(root, text = 'Text Description To Image Generation using GAN for Birds',fg = 'white', bg = "blue")
	...
	label1.grid(row = 1, column = 0, padx = 15)


	
	# Create a text area box
	# for filling or typing the information.
	text1_field = Text(root, height = 15, width = 45, font = "lucida 15")

		
	# padx keyword argument used to set padding along x-axis .
	# pady keyword argument used to set padding along y-axis .
	text1_field.grid(row = 1, column = 1, padx = 15, pady = 15)
